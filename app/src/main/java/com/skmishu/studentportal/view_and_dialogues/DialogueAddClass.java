...
public class DialogueAddClass extends Dialog implements
    ...
    public DialogueAddClass(Activity a) {
        super(a);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialogue_add_class);
        ...
        teacherNameEt = (EditText) findViewById(R.id.classTeacherName_Et);
        ...
        String[] dayNameArray = getContext().getResources().getStringArray(R.array.day_name_array);
        ArrayAdapter<String> dayAdapter = new ArrayAdapter<String>(getContext(), R.layout.view_spinner_row, dayNameArray);
        dayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        dayIDSpnr.setAdapter(dayAdapter);
        dayIDSpnr.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (dayIDSpnr.getSelectedItem().toString().equals("SAT")) {
                    day = "7";
                } else {
